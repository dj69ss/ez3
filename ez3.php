...
<div class="ez3-top">
    <div class="ez3-bar ez3-white ez3-wide ez3-padding ez3-card">
        ...
        <a href="?page=cart" class="ez3-bar-item ez3-button">Cart <?php echo isset($_SESSION['cart']) ? count($_SESSION['cart']) : 0; ?></a>
    </div>
</div>
...
<header>
  <div class="container">
    <div class="logo">
      <img class="small-round-img" src="EZ.png" alt="EZ3 Motor Deals Logo">
    </div>
